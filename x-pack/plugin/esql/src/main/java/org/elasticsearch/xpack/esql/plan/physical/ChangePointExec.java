...
public class ChangePointExec extends UnaryExec {
    ...
    protected NodeInfo<? extends ChangePointExec> info() {
        return NodeInfo.create(this, ChangePointExec::new, child(), value, key, partitionField, targetType, targetPvalue);
    }

    @Override
    public ChangePointExec replaceChild(PhysicalPlan newChild) {
        return new ChangePointExec(source(), newChild, value, key, partitionField, targetType, targetPvalue);
    }
    ...
    public boolean equals(Object other) {
        return super.equals(other)
            ...
            && Objects.equals(partitionField, ((ChangePointExec) other).partitionField)
