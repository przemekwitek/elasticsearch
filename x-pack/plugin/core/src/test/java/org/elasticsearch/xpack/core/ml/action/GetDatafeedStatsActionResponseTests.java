...
public class GetDatafeedStatsActionResponseTests extends AbstractStreamableTestCase<Response> {
    ...
    public void testDatafeedStatsToXContent() throws IOException {
        ...
        DatafeedTimingStats timingStats = new DatafeedTimingStats("my-job-id", 5, 123.456, 78.9);
        ...
        assertThat(timingStatsMap.size(), is(equalTo(4)));
        ...
        assertThat(timingStatsMap, hasEntry("average_bucket_search_time_ms", 78.9));
    }
}
